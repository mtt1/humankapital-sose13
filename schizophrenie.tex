...
%
%Im neoliberalen Verständnis setzt sich das Humankapital zusammen aus
%angeborenen und erworbenen Bestandteilen \vgl{316}{gbp}, aus
%Fähigkeiten, für deren Einsatz die Arbeiterin einen Lohn erhält. Aus
...
%nicht die ganze geleistete \emph{Arbeit} als variables Kapital in der
...
\subsubsection{Mittelteil, Kontext, Krise der Disziplinargesellschaft,
Subjekt}
...
zur Selbst-Un\-ter\-wer\-fung zu gehen. Und für das Humankapital als Subjekt
...
und im Kon\-kret-wer\-den dieser Quantitäten selbst konkret wird,
...
Abschnitts stand das Zitat von Deleuze, man müsse die Schizophrenie
"`in ihrer Positivität und als Positivität"' \pc{24}{schizg}
betrachten. Aber worin soll dieses Positive der Schizophrenie
bestehen?
...
ein für alle Mal lösen. \worries{Irgendwo das ganze Zitat zum
...
diese Grenzen auf ständig sich erweiternder Stufenleiter ausdehnt und
