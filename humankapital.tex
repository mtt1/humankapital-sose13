...
Während frühere Gesellschaften (Deleuze und Guattari unerscheiden
Wildheit, Barbarei und Zivilisation \worries{? vgl}) gekennzeichnet
waren von klaren Territorialitäten (Ländern, Zünften \worries{...})
und Codes ("`Rassen"' \worries{oder doch Territorialitäten?}) ... und
Überkodierung ..., sei das Besondere am Kapitalismus eben die
allgemeine Decodierung und Deterritorialisierung, die ihre Bedeutung
schon für seine Entstehung haben: "`Tatsächlich entsteht er [der
...
Mehrwert, die irgendwie zueinander in Beziehung stehen, sowohl einer
Beziehung der Zusammenfassung im Wert, dem neuen Wert, als auch einer
der Abstoßung, des neuen Werts als Mehrwert über den alten. Außerdem
spielt eine besondere Zeitlichkeit eine Rolle. Ein bestimmtes
...
Der Kreislauf des Kapitals ist das, was oben als schizophrener Prozess
beschrieben wurde: die "`Einheit von Spaltung (schize) und Strom"'
\pc{296}{ao}. \worries{?}
